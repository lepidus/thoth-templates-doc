...
This document provides a comprehensive mapping between ONIX 3.0 XML elements and Thoth model attributes.
...
|---|---|---|
| `workType` | - | No matching element, allow the user to select |
